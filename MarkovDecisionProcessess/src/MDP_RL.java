...
public class MDP_RL {
    ...
    public static void main(String[] args) throws Exception {
        MazeMarkovDecisionProcess maze = MazeMarkovDecisionProcess.load("data/maze_l.txt");
        System.out.println(maze);
        
        ValueIteration vi = new ValueIteration(.9, maze);
        ...
        PolicyIteration pi = new PolicyIteration(.9, maze);
        ...
        QLambda ql = new QLambda(.5, 0.99, .2, 1, new EpsilonGreedyStrategy(.3), maze);
